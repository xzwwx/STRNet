...
# Group Block contains 2D�?D，（2+1）D，Relation branches
...
class STRNet(nn.Module):
    def __init__(self, num_classes=101, modality='RGB', basemodel=None, pretrained_parts="scrach", dropout=0.5, num_frames=16 ):
        ...
        # -------------- conv3d -----------------------
        self.res_3a_2 = STConv3d(96, 128, kernel_size=3, padding=1, stride=1)
        self.res_3b_1 = STConv3d(128, 128, kernel_size=3, padding=1, stride=1)
        self.res_3b_2 = STConv3d(128, 128, kernel_size=3, padding=1, stride=1)

        self.res_4a_1 = STConv3d(128, 256, kernel_size=3, padding=1, stride=2)
        self.res_4a_2 = STConv3d(256, 256, kernel_size=3, padding=1, stride=1)
        self.res_4a_down = STConv3d(128, 256, kernel_size=3, padding=1, stride=2)

        self.res_4b_1 = STConv3d(256, 256, kernel_size=3, padding=1, stride=1)
        self.res_4b_2 = STConv3d(256, 256, kernel_size=3, padding=1, stride=1)

        self.res_5a_1 = STConv3d(256, 512, kernel_size=3, padding=1, stride=2)
        self.res_5a_2 = STConv3d(512, 512, kernel_size=3, padding=1, stride=1)
        self.res_5a_down = STConv3d(256, 512, kernel_size=3, padding=1, stride=2)

        self.res_5b_1 = STConv3d(512, 512, kernel_size=3, padding=1, stride=1)
        self.res_5b_2 = STConv3d(512, 512, kernel_size=3, padding=1, stride=1)
        # --------------- 3d end --------------------

        # -------------- ST 2+1 d -----------------------
        self.st_res_3a_2 = BasicConv3d(512, 128, kernel_size=3, padding=1, stride=1)
        self.st_res_3b_1 = BasicConv3d(128, 128, kernel_size=3, padding=1, stride=1)
        self.st_res_3b_2 = BasicConv3d(128, 128, kernel_size=3, padding=1, stride=1)

        self.st_res_4a_1 = BasicConv3d(128, 256, kernel_size=3, padding=1, stride=1)
        self.st_res_4a_2 = BasicConv3d(256, 256, kernel_size=3, padding=1, stride=1)
        self.st_res_4a_down = BasicConv3d(128, 256, kernel_size=3, padding=1, stride=1)

        self.st_res_4b_1 = BasicConv3d(256, 256, kernel_size=3, padding=1, stride=1)
        self.st_res_4b_2 = BasicConv3d(256, 256, kernel_size=3, padding=1, stride=1)

        self.st_res_5a_1 = BasicConv3d(256, 512, kernel_size=3, padding=1, stride=1)
        self.st_res_5a_2 = BasicConv3d(512, 512, kernel_size=3, padding=1, stride=1)
        self.st_res_5a_down = BasicConv3d(256, 512, kernel_size=3, padding=1, stride=1)

        self.st_res_5b_1 = BasicConv3d(512, 512, kernel_size=3, padding=1, stride=1)
        self.st_res_5b_2 = BasicConv3d(512, 512, kernel_size=3, padding=1, stride=1)
        # ---------------  ST 2+1 d end --------------------
...
if __name__=='__main__':
    ...
    num_frames = 16
    model = STRNet(num_classes=101, num_frames=num_frames)
